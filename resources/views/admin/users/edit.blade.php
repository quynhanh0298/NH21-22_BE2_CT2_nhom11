                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="custom-control custom-radio">
                                                    <input class="custom-control-input" value="1" type="radio" id="active" name="role_id" {{ $user->role_id == 1 ? ' checked=""' : '' }}>
                                                    <label for="active" class="custom-control-label">User</label>
                                                </div>
                                                <div class="custom-control custom-radio">
                                                    <input class="custom-control-input" value="2" type="radio" id="no_active" name="role_id" {{ $user->role_id == 2 ? ' checked=""' : '' }}>
                                                    <label for="no_active" class="custom-control-label">Admin</label>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="menu">Name</label>
                                                <input type="text" name="name" class="form-control" placeholder="Input Name" required value="{{ $user->name }}">
                                            </div>

                                            <div class="form-group">
                                                <label for="menu">Email</label>
                                                <input type="email" name="email" class="form-control" placeholder="Input Email" required value="{{ $user->email }}">
                                            </div>
